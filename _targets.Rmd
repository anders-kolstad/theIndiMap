...
<!-- Let's create a vector of distinct values from these multiple-choice fields and them sample from that to re-populate the columns in our dummy data. -->

<!-- ```{targets splitMS, tar_globals=T} -->
<!-- splitMS <- function(x) { -->


<!--   splitDF <- data.frame(NULL) -->
<!--   temp <- x %>% -->
<!--     filter(mc) -->
<!--   temp2 <-  -->
